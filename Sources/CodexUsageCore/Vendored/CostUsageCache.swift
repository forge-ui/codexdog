...
enum CostUsageCacheIO {
    ...
    private static let compatibleCodexProducerKeys: Set<String> = [
        // Upstream CodexBar v0.44.0 parser snapshot before CodexDog-specific cache namespacing.
        "codex:cu:p2d056ae5a24d5157",
        // CodexDog snapshot before unused Git worktree canonicalization was removed.
        "codex:cu:pa691a2a2543475d8",
    ]
    ...
    private static func defaultCacheRoot() -> URL {
        ...
        return root.appendingPathComponent("CodexRelay", isDirectory: true)
